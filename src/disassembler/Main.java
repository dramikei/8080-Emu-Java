...
//		System.out.println("Opcode: 0x"+String.format("%x", code));
		...
		case 0xe0: System.out.println(String.format("%04d", pc)+"	RPO	1"); break;
		case 0xe1: System.out.println(String.format("%04d", pc)+"	POP	H"); break;
		case 0xe2: System.out.println(String.format("%04d", pc)+"	JPO	$"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xe3: System.out.println(String.format("%04d", pc)+"	XTHL"); break;
		case 0xe4: System.out.println(String.format("%04d", pc)+"	CPO	$"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xe5: System.out.println(String.format("%04d", pc)+"	PUSH	H"); break;
		case 0xe6: System.out.println(String.format("%04d", pc)+"	ANI	#$"+String.format("%x",dat[pc+1])); opbytes=2; break;
		case 0xe7: System.out.println(String.format("%04d", pc)+"	RST	4"); break;
		case 0xe8: System.out.println(String.format("%04d", pc)+"	RPE"); break;
		case 0xe9: System.out.println(String.format("%04d", pc)+"	PCHL"); break;
		case 0xea: System.out.println(String.format("%04d", pc)+"	JPE	$"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xeb: System.out.println(String.format("%04d", pc)+"	XCHG"); break;
		case 0xec: System.out.println(String.format("%04d", pc)+"	CPE $"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xed: System.out.println(String.format("%04d", pc)+"	NOP"); break;
		case 0xee: System.out.println(String.format("%04d", pc)+"	XRI	#$"+String.format("%x",dat[pc+1])); opbytes=2; break;
		case 0xef: System.out.println(String.format("%04d", pc)+"	RST	5"); break;
		case 0xf0: System.out.println(String.format("%04d", pc)+"	RP"); break;
		case 0xf1: System.out.println(String.format("%04d", pc)+"	POP	PSW"); break;
		case 0xf2: System.out.println(String.format("%04d", pc)+"	JP	$"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xf3: System.out.println(String.format("%04d", pc)+"	DI"); break;
		case 0xf4: System.out.println(String.format("%04d", pc)+"	CP	$"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xf5: System.out.println(String.format("%04d", pc)+"	PUSH	PSW"); break;
		case 0xf6: System.out.println(String.format("%04d", pc)+"	ORI	#$"+String.format("%x",dat[pc+1])); opbytes=2; break;
		case 0xf7: System.out.println(String.format("%04d", pc)+"	RST	6"); break;
		case 0xf8: System.out.println(String.format("%04d", pc)+"	RM"); break;
		case 0xf9: System.out.println(String.format("%04d", pc)+"	SPHL"); break;
		case 0xfa: System.out.println(String.format("%04d", pc)+"	JM	$"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xfb: System.out.println(String.format("%04d", pc)+"	EL"); break;
		case 0xfc: System.out.println(String.format("%04d", pc)+"	CM	$"+String.format("%x", dat[pc+2])+String.format("%x", dat[pc+1]));opbytes=3; break;
		case 0xfd: System.out.println(String.format("%04d", pc)+"	NOP"); break;
		case 0xfe: System.out.println(String.format("%04d", pc)+"	CPI	#$"+String.format("%x",dat[pc+1])); opbytes=2; break;
		case 0xff: System.out.println(String.format("%04d", pc)+"	RST	7"); break;
